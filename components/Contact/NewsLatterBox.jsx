...
import qrcode from "../../public/images/qrnsandfjnadsf.jpg";
const NewsLatterBox = () => {
  return (
    <div
    ...
    >
      ...
      Note: Registration for conference is must to attend workshop/Hands on training with addition to workshop registration
      </p>
      <table className="min-w-full divide-y divide-gray-200">
<tbody className="divide-y divide-gray-200">
<tr>
<td className="px-1 py-3 text-sm font-medium text-gray-400 whitespace-nowrap">
<p><strong>Name&nbsp; </strong></p>
</td>
<td className="px-1 py-3 text-sm font-medium text-gray-200 whitespace-nowrap">
<p>ASI-NATCON 70</p>
</td>
</tr>
<tr>
...
<td className="px-1 py-3 text-sm font-medium text-gray-200 whitespace-nowrap">
<p>C-Sector, Barapani Bazar, <br/> Naharlagun, Papum pare, <br/> Arunachal Pradesh, 791110</p>
</td>
</tr>
<tr>
<td className="px-1 py-3 text-sm font-medium text-gray-200 whitespace-nowrap">
